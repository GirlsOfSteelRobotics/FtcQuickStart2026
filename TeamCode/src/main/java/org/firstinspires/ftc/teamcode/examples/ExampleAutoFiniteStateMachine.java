package org.firstinspires.ftc.teamcode.examples; // make sure this aligns with class location
...
@Autonomous(name = "Example Auto (FSM)", group = "Examples")
public class ExampleAutoFiniteStateMachine extends LinearOpMode {
